...
class PluginRegistry {
    private val plugins = mutableListOf<BerryCrushPlugin>()
    private val sortedPlugins: List<BerryCrushPlugin>
     ...
     */
    fun register(plugin: BerryCrushPlugin) {
     ...
     */
    fun register(pluginClass: KClass<out BerryCrushPlugin>) {
     ...
     */
    fun replace(plugin: BerryCrushPlugin) {
     ...
     */
    fun getPlugins(): List<BerryCrushPlugin> = sortedPlugins
