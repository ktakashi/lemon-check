...
class CustomStepExecutionTest {
    ...
    @BeforeEach
    fun setup() {
        val specPath = javaClass.getResource("/petstore.yaml")?.path
    ...
    inner class CustomStepInvocation {
        ...
        fun extractMultipleParameters() {
            val stepInstance = object {
                ...
                fun havePetWithStatus(name: String, status: String) {
                    capturedName = name
            ...
            val definition = StepDefinition(
                ...
                method = stepInstance.javaClass.getMethod(
                    "havePetWithStatus",
                    String::class.java,
                    String::class.java,
                ),
    ...
    inner class StepContextInjection {
        ...
        fun injectStepContextWithOtherParameters() {
            val stepInstance = object {
                ...
                fun setName(name: String, context: StepContext) {
                    capturedName = name
                    receivedContext = context
                }
            }
    ...
    inner class ErrorHandling {
        ...
        fun reportErrorWhenStepThrows() {
            val stepInstance = object {
                ...
                fun fail() {
                    throw RuntimeException("Step failure")
                }
            }
            ...
            assertTrue(result.stepResults[0].error!!.message?.contains("Step failure") == true)
        }
        ...
        fun reportFailedWhenAssertionFails() {
            ...
            assertNotNull(result.stepResults[0].error)
            assertTrue(result.stepResults[0].error!!.message?.contains("Assertion failed") == true)
        }
    }
}
